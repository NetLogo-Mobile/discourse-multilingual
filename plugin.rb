...
after_initialize do
  ...
  require_relative "./extensions/post_alerter.rb"
  require_relative "./extensions/topic.rb"
  require_relative "./extensions/notify_mailing_list_subscribers.rb"
  require_relative "./extensions/search.rb"
  require_relative "./extensions/tag_group.rb"
  require_relative "./extensions/topic_tracking_state.rb"
